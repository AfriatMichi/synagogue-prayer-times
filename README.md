...
הודעת WhatsApp מגבאי
   ...
   Telegram Bot
        ↓
GitHub Actions — 4 ניסיונות בשעה, ~5 דקות האזנה בכל הרצה
        ↓
...
**כמה זמן לוקח פרסום?** כל הרצה מאזינה ~5 דקות עם long polling של טלגרם,
...
הלולאה קצרה בכוונה: בלולאה ארוכה שלושת הניסיונות הנוספים בשעה נבלעים
כ"ממתינים" מאחורי ההרצה הפעילה ולא נראים כלל, ואי אפשר לדעת כמה מהם GitHub
באמת מספק. המחיר הוא כיסוי — גם אם כל ארבעת הניסיונות עוברים, הבוט מאזין
כשליש מהשעה.
