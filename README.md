...
הודעת WhatsApp מגבאי
   ...
   Telegram Bot
        ↓
GitHub Actions — הרצה שעתית, ~50 דקות האזנה בכל הרצה
        ↓
...
**כמה זמן לוקח פרסום?** כל הרצה מאזינה ~50 דקות עם long polling של טלגרם,
ומופעלת פעם בשעה. כשההרצה פעילה — ההודעה, התצוגה המקדימה והאישור מטופלים תוך
שניות, הכל באותה הרצה. אחרת ממתינים לתחילת ההרצה הבאה.
